#!/bin/sh
#Scanner Wizard (c) BarryK 2003 www.goosee.com/puppy
...
RESULTOK="`Xdialog --wmclass "scannerwizard" --title "PLinux scanner wizard" --stdout \
...
if [ $STATUSRET -eq 0 ];then
 ...
 Xdialog --wmclass "scannerwizard" --title "PLinux scanner wizard" \
