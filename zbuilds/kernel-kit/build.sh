...
ksubdir=v${kernel_series}.x #ex: http://www.kernel.org/pub/linux/kernel/v3.x
aufs_git_dir=aufs${kernel_series}_sources_git # ex: aufs3_sources_git dir
case $kernel_series in
	3) aufs_git="https://git.code.sf.net/p/aufs/aufs3-standalone" ;;
	4) aufs_git="git://github.com/sfjro/aufs4-standalone.git" ;;
	5) aufs_git="git://github.com/sfjro/aufs5-standalone.git" ;;
esac
...
- output/huge-${OUTPUT_VERSION}.tar.bz2
  ...
  you can use this to replace vmlinuz and zdrv.sfs from the current wce PLinux install..
