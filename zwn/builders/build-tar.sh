...
DISTRO_NAME='$DISTRO_PREFIX PLinux'
...
### main
mkdir -p $ISO_ROOT
! [ -e $ISO_ROOT/$CORE_SFS ] && echo Put $CORE_SFS to $ISO_ROOT. && exit 1
install_kernel
install_boot_code
install_initrd
make_tar
